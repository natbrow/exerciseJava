...
const infoAlien = aliens.find((alien) => alien.name === 'Cucushumushu');
const infoMutation = mutations.find((mutation) => mutation.name === 'Porompompero')
if (infoAlien && infoMutation) {
    infoAlien.mutation = infoMutation;
